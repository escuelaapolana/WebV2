...
PAGINAS = [
    ...
    ("cross-escolar/index.html",                  "cross-escolar/",                 "0.6",  True),
...
FOTOS = {
    ...
    "cross-escolar/":               "assets/img/noticias-cross-xixona.jpg",
...
KEYWORDS = {
    ...
    "cross-escolar/":               "cross escolar Alicante, cross escolar municipal Alicante, carrera cross niños Alicante, deporte escolar Alicante, cross Monte Tossal, campo a través escolar Alicante",
...
def datos_estructurados(base):
    ...
    ficha = {
        ...
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "Estadio de Atletismo Joaquín Villar · C/ Hondón de las Nieves, 4",
            "postalCode": "03005",
        ...
        "location": [
            {
                ...
                "address": {"@type": "PostalAddress", "streetAddress": "C/ Hondón de las Nieves, 4",
                            "postalCode": "03005", "addressLocality": "Alicante", "addressCountry": "ES"},
            },
            {
                "@type": "Place",
                "name": "El Cubo",
