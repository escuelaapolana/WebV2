-- 195 · Domiciliación integrada en el alta de socio
-- Se recoge el IBAN, el titular de la cuenta y la aceptación de la orden de
-- domiciliación SEPA dentro del propio formulario de "hacerte socio"
-- (equivalente al Google Form del club, pero en la web y con el IBAN).
-- El identificador de acreedor no hace falta aquí: se usa cuando el club
-- genera los recibos en el banco.
